      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-16 md:py-20 grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          >
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><a href="#team" className="hover:text-foreground transition-colors">About Us</a></li>
          ...
          >
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+919999999999" className="hover:text-foreground transition-colors">+91 9999 999 999</a>
              </li>
